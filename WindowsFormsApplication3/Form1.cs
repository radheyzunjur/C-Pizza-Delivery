...
namespace WindowsFormsApplication3
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                ListViewItem item = new ListViewItem("Thumps up - Can");
            ...
            {
                ListViewItem item = new ListViewItem("Egg ROll");
                item.SubItems.Add("");
            ...
            {
                ListViewItem item = new ListViewItem("Chicken Roll");
                item.SubItems.Add("");
            ...
            {
                ListViewItem item = new ListViewItem("Gralic Pops");
                item.SubItems.Add("");
                item.SubItems.Add("80.00");
                listView1.Items.Add(item);
        ...
        {
           DialogResult dialog = MessageBox.Show("Thanks for ordering Pizza. Your ordered items will be ready and delivered in 30 minutes. Do you want to order some more?", "Exit", MessageBoxButtons.YesNo);
